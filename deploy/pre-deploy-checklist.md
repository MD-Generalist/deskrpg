...
- [ ] Two-browser exact-v4 upgrade plus exact-v2 and exact-v3 database-path probes: begin/ready refresh, 42×26/version 5, sanitized live positions and cleared reservations/continuations. Edited v2/v3/v4 maps remain unchanged/legacy. Keep sessions idle until the quiet preservation comparison passes.
