...
COPY --from=builder /app/src/game/three/creative-studio-layout.ts ./src/game/three/creative-studio-layout.ts
COPY --from=builder /app/src/game/three/executive-room-layout.ts ./src/game/three/executive-room-layout.ts
COPY --from=builder /app/src/game/three/office-room-layout.ts ./src/game/three/office-room-layout.ts
COPY --from=builder /app/src/game/three/publishing-room-layout.ts ./src/game/three/publishing-room-layout.ts
